...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      ...
      <span class="site-heading-lower">A Rich History</span>
    </h1>
            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                <h2 class="section-heading mb-4">
                  <span class="section-heading-upper">Healthy Mind, Healthy You</span>
                  <span class="section-heading-lower">About Our Group</span>
                </h2>
                <p>Founded back in the day, we have continued to grow and support the local community.</p>
                <p class="mb-0">We guarantee that you will fall in <em>love</em> with our work the moment you do your first project with us!</p>
              </div>
            </div>
          </div>
        </div>
